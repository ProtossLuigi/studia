...
declarations:     declarations COMMA pidentifier                                                {
                ...
                | declarations COMMA pidentifier LPAR num COLON num RPAR                        {
                                                                                                if (global_variables.count($3.str)) {
                                                                                                    ...
                                                                                                    struct global_variable new_var = {$3.str,no_global_variables+RESERVED_SLOTS-$5.intval,true,$5.intval,$7.intval};
                                                                                                    global_variables.emplace(new_var.name,new_var);
...
expression:       value                                                                         {
                ...
                | value TIMES value                                                             {
                                                                                                ...
                                                                                                if ($1.literal && $3.literal) {
                                                                                                    ...
                                                                                                    $$.instructions = $3.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+$1.instructions.size()*2+36));
                                                                                                    $$.instructions.emplace_back("STORE","5");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+$1.instructions.size()+4));
                                                                                                    $$.instructions += $1.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+$1.instructions.size()+33));
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()+$1.instructions.size()+9));
                                                                                                    $$.instructions.emplace_back("SUB","5");
                                                                                                    $$.instructions.emplace_back("SUB","5");
                                                                                                    $$.instructions.emplace_back("STORE","5");
                                                                                                    $$.instructions += $1.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+27));
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    $$.instructions.emplace_back("LOAD","5");
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+15));
                                                                                                    $$.instructions.emplace_back("STORE","8");
                                                                                                    $$.instructions.emplace_back("SHIFT","3");
                                                                                                    $$.instructions.emplace_back("STORE","5");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("SUB","8");
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+5));
                                                                                                    $$.instructions.emplace_back("LOAD","4");
                                                                                                    $$.instructions.emplace_back("SHIFT","6");
                                                                                                    $$.instructions.emplace_back("ADD","7");
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("INC","");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-15));
                                                                                                    $$.instructions.emplace_back("LOAD","7");
                                                                                                }
                                                                                                }
                | value DIV value                                                               {
                                                                                                $$.used_variables = $1.used_variables + $3.used_variables;
                                                                                                ...
                                                                                                if ($3.literal && $3.intval == 0) {
                                                                                                    ...
                                                                                                    $$.instructions = $3.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+$1.instructions.size()*2+139));
                                                                                                    $$.instructions.emplace_back("STORE","5");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+$1.instructions.size()+66));
                                                                                                    $$.instructions += $1.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+$1.instructions.size()+136));
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+32));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //both positive
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("STORE","8");
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    $$.instructions.emplace_back("JPOS",std::to_string($$.instructions.size()+$1.instructions.size()+124));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    $$.instructions.emplace_back("JPOS",std::to_string($$.instructions.size()+5));
                                                                                                    $$.instructions.emplace_back("LOAD","7");
                                                                                                    $$.instructions.emplace_back("INC","");
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-8));
                                                                                                    $$.instructions.emplace_back("LOAD","1");
                                                                                                    $$.instructions.emplace_back("SHIFT","7");
                                                                                                    $$.instructions.emplace_back("ADD","8");
                                                                                                    $$.instructions.emplace_back("STORE","8");
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","3");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("LOAD","4");
                                                                                                    $$.instructions.emplace_back("SUB","6");
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("SUB","0");
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-25));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //negative positive
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("STORE","8");
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("JPOS",std::to_string($$.instructions.size()+$1.instructions.size()+88));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("LOAD","4");
                                                                                                    $$.instructions.emplace_back("ADD","6");
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("SUB","0");
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-25));
                                                                                                    $$.instructions += $1.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+71));
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+32));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //positive negative
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("STORE","8");
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+54));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+5));
                                                                                                    $$.instructions.emplace_back("LOAD","7");
                                                                                                    $$.instructions.emplace_back("INC","");
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-8));
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-25));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //negative negative
                                                                                                    $$.instructions.emplace_back("STORE","7");
                                                                                                    $$.instructions.emplace_back("STORE","8");
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+28));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-25));
                                                                                                    $$.instructions.emplace_back("LOAD","4");
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+4));
                                                                                                    $$.instructions.emplace_back("LOAD","8");
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()+2));
                                                                                                    $$.instructions.emplace_back("LOAD","8");
                                                                                                }
                ...
                | value MOD value                                                               {
                                                                                                ...
                                                                                                if ($3.literal && $3.intval == 0) {
                                                                                                    ...
                                                                                                    $$.instructions = $3.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+$1.instructions.size()*2+94));
                                                                                                    $$.instructions.emplace_back("STORE","5");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+$1.instructions.size()+44));
                                                                                                    $$.instructions += $1.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+$1.instructions.size()+91));
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+21));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //both positive
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    $$.instructions.emplace_back("LOAD","5");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    $$.instructions.emplace_back("JPOS",std::to_string($$.instructions.size()+$1.instructions.size()+81));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("SUB","6");
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-16));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //negative positive
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    $$.instructions.emplace_back("STORE","3");
                                                                                                    $$.instructions.emplace_back("LOAD","5");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    $$.instructions.emplace_back("JPOS",std::to_string($$.instructions.size()+$1.instructions.size()+57));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()-16));
                                                                                                    $$.instructions += $1.instructions;
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+48));
                                                                                                    $$.instructions.emplace_back("STORE","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+21));
                                                                                                    $$.instructions.emplace_back("SUB","0");    //positive negative
                                                                                                    $$.instructions.emplace_back("DEC","");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+34));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("ADD","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    $$.instructions.emplace_back("JNEG",std::to_string($$.instructions.size()+18));
                                                                                                    $$.instructions.emplace_back("LOAD","6");
                                                                                                    $$.instructions.emplace_back("SHIFT","1");
                                                                                                    $$.instructions.emplace_back("STORE","6");
                                                                                                    $$.instructions.emplace_back("SUB","4");
                                                                                                    ...
                                                                                                    $$.instructions.emplace_back("LOAD","4");
                                                                                                    $$.instructions.emplace_back("JZERO",std::to_string($$.instructions.size()+4));
                                                                                                    $$.instructions.emplace_back("ADD","5");
                                                                                                    $$.instructions.emplace_back("JUMP",std::to_string($$.instructions.size()+2));
                                                                                                    $$.instructions.emplace_back("LOAD","4");
                                                                                                }
                                                                                                }
