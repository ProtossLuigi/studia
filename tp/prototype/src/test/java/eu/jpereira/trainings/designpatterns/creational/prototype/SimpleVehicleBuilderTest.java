...
public class SimpleVehicleBuilderTest {
	...
	@Test
    public void testClone() throws NeedToPackLastVehicleException, CouldNotCloneLastObjectException, CannotHaveZeroPartsException, CloneNotSupportedException, VehicleDoesNotHavePartsException {
	    SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
	    Vehicle vehicle1 = builder.createVehicle().with(new Tire()).times(15).packIt();
	    Vehicle vehicle2 = (Vehicle) vehicle1.clone();
	    assertEquals(15,vehicle2.countParts());
    }
