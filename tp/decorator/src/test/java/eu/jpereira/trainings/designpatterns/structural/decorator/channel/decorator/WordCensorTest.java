...
public class WordCensorTest extends AbstractSocialChanneldDecoratorTest {
    ...
    @Test
    public void testCensorWithoutBuilder(){
        SocialChannel channel = new TestSpySocialChannel();
        SocialChannel censoredChannel = new WordCensor("message",channel);
        censoredChannel.deliverMessage("this is a message");
        assertEquals("this is a ###",((TestSpySocialChannel)channel).lastMessagePublished());
    }
}
